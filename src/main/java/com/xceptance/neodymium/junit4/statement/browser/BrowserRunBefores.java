...
public class BrowserRunBefores extends RunBefores
{
    ...
    public void evaluate() throws Throwable
    {
        ...
        for (FrameworkMethod before : befores)
        {
            ...
            List<Browser> methodBrowserAnnotations = Data.getAnnotations(before.getMethod(), Browser.class);
    ...
    {
        List<DontStartNewBrowserForSetUp> methodStartNewBrowserForSetUp = Data.getAnnotations(each.getMethod(),
