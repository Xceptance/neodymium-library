...
public class BrowserRunAfters extends RunAfters
{
    ...
    public void evaluate() throws Throwable
    {
        ...
        finally
        {
            ...
            for (FrameworkMethod each : afters)
            {
                ...
                List<Browser> methodBrowserAnnotations = Data.getAnnotations(each.getMethod(), Browser.class);
                ...
                {
                    WebDriverStateContainer wDSCont = BrowserRunnerHelper.createWebDriverStateContainer(browserConfiguration, target);
    ...
    {
        List<DontStartNewBrowserForCleanUp> methodStartNewBrowserForCleanUp = Data.getAnnotations(each.getMethod(),
    ...
    {
        List<SuppressBrowsers> methodSuppressBrowserAnnotations = Data.getAnnotations(each.getMethod(), SuppressBrowsers.class);
